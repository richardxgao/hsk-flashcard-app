...
class HomePage(Frame):
    def __init__(self, parent):
        ...
        Label(buttons_frame, text="Choose a deck to begin:").grid(row=0, column=0, columnspan=3)
        Button(buttons_frame, text="HSK1", command=lambda: parent.show_page(parent.pages['HSK1'])).grid(row=1, column=0, padx=5, pady=5)
        ...
        Button(buttons_frame, text="Load Deck").grid(row=1, column=2, padx=5, pady=5)
        Button(buttons_frame, text="Custom Select").grid(row=2, column=2, padx=5, pady=5)
        Button(buttons_frame, text="Starred Deck").grid(row=3, column=2, padx=5, pady=5)
